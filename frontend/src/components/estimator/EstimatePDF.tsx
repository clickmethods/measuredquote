...
export default function EstimatePDF({
  ...
  const translations = {
    en: {
      ...
      generatedBy: 'Generated by Draw-to-Quote',
    ...
    es: {
      ...
      generatedBy: 'Generado por Draw-to-Quote',
      website: 'draw-to-quote.com',
      page: 'Pagina',
      of: 'de',
    },
  ...
  return (
    <Document title={`Draw-to-Quote Estimate - ${clientName}`}>
      <Page size="LETTER" style={styles.page} wrap>
        {/* ── HEADER ── */}
        <View style={styles.header} fixed>
          <View style={styles.headerBrand}>
            <View style={styles.logoBox} />
            <Text style={styles.brandName}>Draw-to-Quote</Text>
          </View>
